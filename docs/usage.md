...
```bash
nextflow run nf-cmgg/report -profile docker -params-file params.yaml
```
...
- `targeted_msh2`
  - A MSH2 specific configuration profile for the `targeted` workflow.
