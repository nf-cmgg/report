...
def write_report(sample_name, input_path):  

    filepath = os.path.join(input_path, "trgt")
...
parser = argparse.ArgumentParser(description="Create Excel reports from output VCF files of the nf-core/pacvar repeat pipeline")
parser.add_argument('--sample_name', metavar='STR', type=str, help="Name of the sample", required=True)
parser.add_argument('--input_path', metavar='DIR', type=str, help="Path to nf-core/pacvar repeat output directory, containing the input VCFs in the trgt subfolder", required=True)

args = parser.parse_args()
sample_name:str = args.sample_name
input_path:str = args.input_path + "/"

write_report(sample_name=sample_name, input_path=input_path)